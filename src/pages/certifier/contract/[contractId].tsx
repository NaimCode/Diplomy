import { Diplome, Etablissement, Etudiant, Formation, Version } from "@prisma/client";
...
import { BackIcon, PersonIcon, EmailIcon, DiplomaIcon, CopyIcon, CodeQRIcon } from "../../../constants/icons";
import { env } from "../../../env/client.mjs";
import { useMyTheme, useMyTransition, useQR, GATEWAY_IPFS } from "../../../utils/hooks";
...
export const getServerSideProps: GetServerSideProps = async (context) => {
    ...
    const contract:MContract=await prisma?.contract.findUniqueOrThrow({
        where:{
            id
        },
        include:{
